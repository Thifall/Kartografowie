...
using Kartografowie.Assets.Scripts.Scoring.Rules.Coins;
using Kartografowie.Assets.Scripts.Scoring.Rules.Forests;
using Kartografowie.Assets.Scripts.Scoring.Rules.Misc;
using Kartografowie.Assets.Scripts.Scoring.Rules.Monsters;
...
namespace Kartografowie.Assets.Scripts.Scoring.Core
{
    public class ScoreManager : MonoBehaviour
    {
        ...
        private void InitializeScoringRules()
        {
            ...
            var monsterPenaltyRule = new MonsterPenaltyRule();
            var coinScoringRule = new CoinsScoringRule(_coinTracker);

            // Assign rules to seasons
            _scoringContext.RegisterSeasonRules(Seasons.Wiosna, new List<ScoringRule> { edictARule, edictBRule, monsterPenaltyRule, coinScoringRule });
            ...
            _scoringContext.RegisterSeasonRules(Seasons.Lato, new List<ScoringRule> { edictBRule, edictCRule, monsterPenaltyRule, coinScoringRule });
            ...
            _scoringContext.RegisterSeasonRules(Seasons.Jesien, new List<ScoringRule> { edictCRule, edictDRule, monsterPenaltyRule, coinScoringRule });
            ...
            _scoringContext.RegisterSeasonRules(Seasons.Zima, new List<ScoringRule> { edictDRule, edictARule, monsterPenaltyRule, coinScoringRule });
